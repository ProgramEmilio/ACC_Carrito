...
-- persona,proveedor,administrador
CREATE TABLE roles (
...
CONSTRAINT fk_persona_direccion FOREIGN KEY (id_persona) REFERENCES persona(id_persona)
);
...
CONSTRAINT fk_usuario_tarjeta FOREIGN KEY (titular) REFERENCES persona(id_persona)
);
...
CONSTRAINT fk_persona_carrito FOREIGN KEY (id_persona) REFERENCES persona(id_persona)
);
...
CONSTRAINT fk_compra_cli FOREIGN KEY (id_persona) REFERENCES persona(id_persona),
...
-- persona
INSERT INTO persona (id_usuario, nom_persona, apellido_paterno, apellido_materno, telefono, monedero) VALUES
(2, 'Juan', 'Pérez', 'Gómez', '6123456789', 50.00);

-- Dirección del persona
INSERT INTO direccion(codigo_postal, calle, num_ext, colonia, ciudad, estado, id_persona) VALUES
...
-- Carrito del persona
INSERT INTO carrito (id_persona, fecha, total) VALUES
(1, NOW(), 800.00);
